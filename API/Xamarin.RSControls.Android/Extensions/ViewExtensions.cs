...
namespace Xamarin.RSControls.Droid.Extensions
{
    ...
    public class RSView : global::Android.Views.ViewGroup
    {
        global::Android.Views.View parent;
        Forms.VisualElement formsView;
        IVisualElementRenderer renderer;

        public RSView(Context context, global::Android.Views.View view, Forms.VisualElement formsView, IVisualElementRenderer renderer, global::Android.Views.View parent, int width, int height) : base(context)
        {
            this.parent = parent;
